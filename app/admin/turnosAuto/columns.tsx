...
export const columns: ColumnDef<TurnoAutoType>[] = [
  {
    accessorKey: "fecha",
    header: ({ column }) => {
        return (
  ...
  },
  {
    ...
    cell:({row})=>{
        const cliente =row.original.usuario?.name ?? "Sin usuario"
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem className=" w-full flex justify-start items-center px-4"><Link href={`/admin/turnoAuto/${turno.id}/ver`}>Ver</Link>
            </DropdownMenuItem>
