...
export default function AdultosSquash() {
  return (
    <>
      <TituloCliente texto=" Escuela de Squash para todas las edades"/>
      <div className='flex flex-col md:flex-row justify-center items-center  gap-3'>
        <div className='w-[90%] md:w-[30%] h-[600px] my-5'>
          ...
          >
            <source src='/imagenes/escuelasquashadulto.mp4' type='video/mp4' />
        ...
        <div className='w-[90%] md:w-[40%]'>
          <Card className='h-[400px] md:h-[600px]'>
            <CardHeader className='flex flex-col justify-center items-center gap-5'>
              ...
              <CardTitle className='text-3xl'>Lunes y Viernes 16:30</CardTitle>
            </CardHeader>
            <CardContent>
